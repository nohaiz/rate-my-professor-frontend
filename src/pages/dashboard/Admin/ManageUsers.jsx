...
const ManageUsers = ({ user }) => {
  ...
  const [isViewAllRatingsVisible, setIsViewAllRatingsVisible] = useState(false)
  ...
  const renderRatings = (userId) => {
    setUserRatingId(userId)
    setIsViewAllRatingsVisible(true)
  }
  ...
  return (
    <div className="space-y-2">
      {isViewAllRatingsVisible ? (<ViewAllRatings setIsViewAllRatingsVisible={setIsViewAllRatingsVisible} userRatingId={userRatingId}/>)
        :
        (
          isUserFormVisible ? (
                          ...
                          <tr key={user._id} className="border-b">
                            ...
                            <td className="px-6 py-4 flex items-center space-x-4">
                              ...
                              {!user.adminAccount && (
                                <button
                                  className="text-black hover:text-gray-800 text-sm"
                                  onClick={() => renderRatings(user._id)}
                                >
